      ...
      child: Row(
        ...
        children: [
          ...
          Icon(
            ...
            color: Colors.black,
            size: 24.0,
            semanticLabel: 'Thay đổi thành phố',
          ),
        ],
      ));
}
          ...
          children: [
            Expanded(
                child: Column(
                  ...
                  Container(
                      margin: const EdgeInsets.all(5.0),
                      child: Text(
                        "Nhiệt độ cao nhất:${_weather.high.toInt()}°     Nhiệt độ thấp nhất:${_weather.low.toInt()}°",
                        textAlign: TextAlign.left,
                        style: TextStyle(
                            fontWeight: FontWeight.normal,
                            fontSize: 13,
            ...
            Column(children: <Widget>[
              ...
              Container(
                  ...
                  child: Text(
                    "Nhiệt độ tốt nhất ${_weather.feelsLike.toInt()}°",
                    textAlign: TextAlign.left,
                    style: TextStyle(
                        fontWeight: FontWeight.normal,
                        fontSize: 13,
...
Future getCurrentWeather(Location location) async {
  ...
  String apiKey = "4ac9dbaffbfc46ed8f4e9d9d0440f0a1";
  var url =
